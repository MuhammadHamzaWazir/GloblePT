          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-green-500 text-black"
              />
            </div>
              ...
              <div key={complaint.id} className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    {complaint.orderId && (
                      <p className="text-sm text-blue-600">Related to Order #{complaint.orderId}</p>
                    )}
                ...
                {complaint.fileUrl && (
                  <div className="mb-4">
                    <a
                      href={`/api/uploads/complaints/${complaint.fileUrl.split('/').pop()}`}
                      target="_blank"
